...
local likelynames = {
	...
	"segway", "handless", "sword", "attack", "despawn", "deletar", "apagar","DestroySegway"
}
				...
				if v.Name:lower():find(phrase) then
					for _, nun in pairs(nonlikelynames) do
						if v.Name:lower():find(nun) then else
							...
							notification("Strawberry", "Make sure testing the commands before logging!", 6)
							return
						end
					end
				end
...
G2L["1a"]["CanvasPosition"] = Vector2.new(0, 447);
...
G2L["5e"] = Instance.new("Frame", G2L["2"]);
G2L["5e"]["ZIndex"] = 2;
G2L["5e"]["BorderSizePixel"] = 0;
G2L["5e"]["BackgroundColor3"] = Color3.fromRGB(255, 255, 255);
G2L["5e"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
G2L["5e"]["Size"] = UDim2.new(0, 30, 0, 30);
G2L["5e"]["Position"] = UDim2.new(0.783, 10, 0.171, 0);
G2L["5e"]["Name"] = [[Check]];
...
G2L["60"]["BackgroundColor3"] = Color3.fromRGB(34, 34, 34);
G2L["60"]["ZIndex"] = 3;
G2L["60"]["AnchorPoint"] = Vector2.new(0.5, 0.5);
G2L["60"]["Image"] = [[http://www.roblox.com/asset/?id=6353957304]];
G2L["60"]["Size"] = UDim2.new(1, -14, 1, -14);
...
G2L["64"] = Instance.new("UIGradient", G2L["5e"]);
G2L["64"]["Color"] = ColorSequence.new{ColorSequenceKeypoint.new(0.000, Color3.fromRGB(255, 52, 89)),ColorSequenceKeypoint.new(1.000, Color3.fromRGB(255, 52, 89))};


-- StarterGui.Strawberry.MainFrame.Check.Anim
G2L["65"] = Instance.new("LocalScript", G2L["5e"]);
G2L["65"]["Name"] = [[Anim]];
